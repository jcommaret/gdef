...
type LeProjetStyles = ReturnType<typeof createLeProjetStyles>;
...
function createLeProjetStyles(isDark: boolean) {
...
export default function LeProjet() {
  ...
  const styles = useMemo(() => createLeProjetStyles(isDark), [isDark]);
  ...
  return (
    ...
    >
      ...
      <Section title="Présentation" styles={styles}>
      ...
      <Section title="Soutiens institutionnels" styles={styles}>
